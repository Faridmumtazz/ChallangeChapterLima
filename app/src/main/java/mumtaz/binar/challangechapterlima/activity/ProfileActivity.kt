...
import mumtaz.binar.challangechapterlima.model.ResponseUpdate
...
class ProfileActivity : AppCompatActivity() {
    ...
    fun updateDataUser( id : Int, address : String, complete_name : String, dateofbirth : String,username : String){
        ApiClient.instance.updateUser(id,dateofbirth, complete_name,address,username)
